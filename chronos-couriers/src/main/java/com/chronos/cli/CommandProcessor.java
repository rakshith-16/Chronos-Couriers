	...
	public void process(String input) {
		...
		try {
			...
			case "PLACE_ORDER":
				...
				dispatchCenter.placeOrder(tokens[1], tokens[2], tokens[3], tokens[4], Boolean.parseBoolean(tokens[5]),
			...
			case "ADD_RIDER":
				...
				dispatchCenter.addRider(tokens[1], tokens[2], Boolean.parseBoolean(tokens[3]),
